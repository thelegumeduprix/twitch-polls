...
export const POLL_QUOTED_PARAMETER_DETECTION_PATTERN = /^!poll( "[^"]*")( "[^"]+"){2,}$/;
export const POLL_QUOTED_PARAMETER_EXTRACTION_PATTERN = /"([^"]*)"/g;
export const POLL_TITLE_DETECTION_PATTERN = /^!polltitle( "[^"]+")$/;
export const POLL_POSITION_DETECTION_PATTERN = /^!poll_tl$|^!poll_tr$|^!poll_br$|^!poll_bl$/;
...
export const isPollTiebreak = (message) => /^!polluntie|^!pollrandom|^!polltiebreak|^!pollresolve/g.test(message);
...
export const isValidVote = (message) => POLL_VOTE_EXTRACTION_PATTERN.test(message);
