...
describe('rendering', function () {
  ...
  describe('when receiving votes while a poll is active', function () {
    ...
    it('updates the option percentages correctly', function () {
      expect(document.querySelector('#option-1 .percentage')).to.have.text('33% (1)');
      expect(document.querySelector('#option-2 .percentage')).to.have.text('33% (1)');
      expect(document.querySelector('#option-3 .percentage')).to.have.text('33% (1)');
    });
  });
  ...
  describe('when receiving votes before and after a poll is active', function () {
    ...
    it('updates the option percentages correctly', function () {
      expect(document.querySelector('#option-1 .percentage')).to.have.text('50% (1)');
      expect(document.querySelector('#option-2 .percentage')).to.have.text('50% (1)');
      expect(document.querySelector('#option-3 .percentage')).to.have.text('0% (0)');
    });
  });
  ...
  describe('when receiving annuled votes and vote changes', function () {
    ...
    it('updates the option percentages correctly', function () {
      expect(document.querySelector('#option-1 .percentage')).to.have.text('50% (1)');
      expect(document.querySelector('#option-2 .percentage')).to.have.text('0% (0)');
      expect(document.querySelector('#option-3 .percentage')).to.have.text('50% (1)');
    });
  });
  ...
  describe('when receiving a poll stop command while a decided poll of 3 was active', function () {
    ...
    it("marks the winning option as 'winning'", function () {
      expect(document.getElementById('option-1')).to.have.class('winning-option');
      expect(document.getElementById('option-2')).to.not.have.class('winning-option');
      expect(document.getElementById('option-3')).to.not.have.class('winning-option');
    });
  });
  ...
  describe('when receiving a poll resume command while a poll was inactive', function () {
    ...
    it('updates the option percentages correctly', function () {
      expect(document.querySelector('#option-1 .percentage')).to.have.text('0% (0)');
      expect(document.querySelector('#option-2 .percentage')).to.have.text('0% (0)');
      expect(document.querySelector('#option-3 .percentage')).to.have.text('100% (1)');
    });
  });
